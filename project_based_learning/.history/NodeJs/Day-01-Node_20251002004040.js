...
fs.appendFileSync('test.txt' , `\n\nComplete File Heandling before 12:00 Current Time - ${new Date().toLocaleString() }`)
fs.appendFileSync('test.txt' , `\n\nPrepapre Java For mid sem exam Before 2 Oct 12:00 Current Time - ${new Date().toLocaleString() }`)
